...
export const metadata: Metadata = {
  ...
  description:
    "ค่าบริการทำบัญชีและภาษี บริษัท เคพีอาร์ แอคเคานต์ติ้ง จำกัด ราคาโปร่งใส ไม่มีค่าใช้จ่ายแอบแฝง เริ่มต้น 2,500 บาท/เดือน ตกลงค่างานชัดเจนล่วงหน้า",
};
