...
export default function WhyUs() {
  return (
    <section id="why-us" className="py-24 relative bg-slate-50 border-t border-slate-200">
              ...
              {WHY_US.map((item, idx) => {
                ...
                return (
                  <ScrollReveal key={idx} direction="up" delay={0.1 * idx + 0.2}>
                    <div className="executive-card p-5 rounded-2xl bg-white border border-slate-200 flex items-start gap-4">
          ...
          <div className="lg:col-span-5">
            <ScrollReveal direction="left" delay={0.3}>
              <div className="executive-card rounded-3xl p-8 bg-[#0D2240] text-white border border-slate-800 shadow-xl relative overflow-hidden">
                ...
                <h3 className="text-2xl font-bold mb-6 font-serif border-b border-slate-700/80 pb-4 text-white">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-xs font-light">ยื่นภาษีและปิดงบการเงินตรงตามกำหนดเวลาทางราชการแน่นอน</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-xs font-light">แจ้งรายละเอียดและค่างานชัดเจน ปราศจากค่าใช้จ่ายแอบแฝง</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-xs font-light">ทีมงาน CPA และทนายความพร้อมเข้าพบเจ้าหน้าที่สรรพากรแทนท่าน</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-slate-700/80">
                  ...
                  <div className="text-slate-300 text-[11px] mt-1 font-light">
